const abi = [
  ...
  {
    inputs: [{ internalType: "address", name: "currentHook", type: "address" }],
  ...
  { stateMutability: "payable", type: "fallback" },
  {
    ...
    outputs: [{ internalType: "bytes", name: "init", type: "bytes" }],
  ...
  {
    inputs: [
      { internalType: "contract IModule", name: "validator", type: "address" },
      { internalType: "bytes", name: "data", type: "bytes" },
    ],
    name: "singleInitMSA",
    outputs: [],
